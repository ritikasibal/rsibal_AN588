---
title: "rsibal_PeerCommentary_emileygz_05"
...
**peer commentary: I like how you named your vectors and variables. Made it easy to understand and follow along. 
``` {r HW1.1}
library(curl)
...
**peer commentary: was there a reason you used dplyr rather than boot. The forloop looks much better the called function in boot, was just curious if you tried both.  
``` {r HW1.2}
library(dplyr)
...
**peer commentary: I also got this. Good job! 
...
**peer commentary: This looks really good! Sorry I couldn't offer more advice but it looks like you figured everything out. I really like how you organized everything, it made it very easy to follow and understand. Great job! 
